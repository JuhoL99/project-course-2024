...
public class ResetMeleeColliderFront : StateMachineBehaviour
{
    ...
    {
        PlayerWeapon fist = GameObject.FindWithTag("WeaponMain").GetComponent<PlayerWeapon>();
